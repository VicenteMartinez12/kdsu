...
from .views import OrderTestView,plantilla_consultas_view,index2,obtener_detalles_orden,plantilla_pdf_view,export_pdf,export_xml,export_xml_excel,export_json,descarga_pedidos_view,obtener_detalle_descarga_pedidos,obtener_tabla_descarga_pedidos,pruebaConexion,pruebaConexionSFTP,subir_archivo
...
urlpatterns = [
    ...
    path('pruebaConexion/', pruebaConexion, name='pruebaConexion'),
    path('pruebaConexionSftp/', pruebaConexionSFTP, name='pruebaConexionSftp'),
    path('subir-archivo/', subir_archivo, name='subir_archivo_sftp'),
